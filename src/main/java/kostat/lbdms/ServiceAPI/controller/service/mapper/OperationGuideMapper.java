...
@Repository("operationGuideMapper")
public class OperationGuideMapper extends EgovAbstractMapper {
	...
	public List getGuideList(Map mapParameter) throws SQLException {
		return selectList("guide.getGuideList", mapParameter);
	}
	...
	public Map getGuideDetailInfo(Map mapParameter) throws SQLException {
		return selectOne("guide.getGuideDetailInfo", mapParameter);
	}
	...
	public List getFileList(Map mapParameter) throws SQLException {
		return selectList("guide.getFileList", mapParameter);
	}
	...
	public int updateViewCnt(Map mapParameter) throws SQLException {
		return update("guide.updateViewCnt", mapParameter);
	}
}