...
@Repository("attachFileMapper")
public class AttachFileMapper extends EgovAbstractMapper {
	...
	public int insertAttachFile(Map mapParameter) throws SQLException {
		return insert("attach.insertAttachFile", mapParameter);
	}
	...
	public Map getAttachFile(Map mapParameter) throws SQLException {
		return selectOne("attach.getAttachFile", mapParameter);
	}
	...
	public int deleteAttachFile(Map mapParameter) throws SQLException {
		return delete("attach.deleteAttachFile", mapParameter);
	}
}