...
public interface LocationRankAnalysisService {
	...
	public JSONObject rankAnalysis(MyDataAnalysis myDataAnalysis, JSONArray condition_list) throws SystemFailException;
