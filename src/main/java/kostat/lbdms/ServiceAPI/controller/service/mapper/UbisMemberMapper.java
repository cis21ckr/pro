...
@Repository("ubisMemberMapper")
public class UbisMemberMapper extends EgovAbstractMapper {

	@Resource(name = "sqlSessionSystemUbis")
	...
	public Map getUbisUserInfo(Map mapParameter) throws SQLException {
		return selectOne("ubis.getUbisUserInfo", mapParameter);
	}
	...
	public int getUbisUserCheck(Map mapParameter) throws SQLException {
		return selectOne("ubis.getUbisUserCheck", mapParameter);
	}
}