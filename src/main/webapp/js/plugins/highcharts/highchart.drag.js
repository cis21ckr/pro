...
(function (Highcharts) {
    ...
    Highcharts.Chart.prototype.callbacks.push(function (chart) {
        ...
        function drop(e) {
            if (dragPoint) {
                if (e) {
                    //dragPoint.update(getNewPos(e)); //업데이트 문제때문에 주석
                }
        ...
        function mouseDown(e) {
            ...
            }else*/ if ((originalEvent.target.getAttribute('class') || '').indexOf('arrow_grip') !== -1) {
                var idx = $(originalEvent.target).attr("id").split("image_")[1];
                hoverPoint = chart.series[0].points[parseInt(idx)];
            }
