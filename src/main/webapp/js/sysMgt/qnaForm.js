(function(W,D){
	...
	$(document).ready(function(){
		...
		$dataForm.ui.getqnaForm();
		$dataForm.event.setUIEvent();	
		$log.srvLogWrite("Z1", "03", "02", "05", "", "");
	});
	...
	$dataForm.ui = {
		...
		getqnaForm : function(){
			...
			$dataForm.request.getqnaForm(obj);
		},
		cancel : function(){
			if(confirm("정말 게시물 작성을 취소하시겠습니까?") == true){
				window.location.href = contextPath + '/view/sysmgt/qnaLst';
			}
		}
	};
	$dataForm.request = {
		getqnaForm : function(data){
