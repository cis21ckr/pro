(function(W,D){
	...
	$dataForm.ui = {
		post_no : null,
		file_num: 1,
		getshareForm : function(){
			var obj = {
					params : {
						post_no : $dataForm.ui.post_no
						}
			};
			$dataForm.request.getshareForm(obj);
		},
		cancel : function(){
			if(confirm("정말 게시물 작성을 취소하시겠습니까?") == true){
				window.location.href = contextPath + '/view/sysmgt/shareLst';
			}
		}
	};
	$dataForm.request = {
		getshareForm : function(data){
