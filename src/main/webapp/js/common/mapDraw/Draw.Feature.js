...
Draw.Feature = sop.Control.Measure.Overlay.extend({
	...
	_endVector : function (e) {
		...
		/*if (shapeArea < 20000) {
			...
			this._addCloseButton(e.utmk, layer);
		//}
		this._infoWindow._close();
		
	},
	
	_addCloseButton : function (utmk, layer) {
	...
	_fireDeleteEvent : function (layer) {
