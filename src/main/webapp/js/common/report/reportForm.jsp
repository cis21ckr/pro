...
<body>
	...
	<div id="wrap">
		<div class="printArea">
			<div class="pntPage">
				<h1 class="pntHeader"><img src="${pageContext.request.contextPath}/img/common/logo.png" alt="SGIS pro" style="width:125px;height:63px;"></h1>	 
		 		<div class="pntBtn">
		 		...
		 		<p class="pntURI">SGIS Pro (http://sop.nsi.go.kr/pro)</p> 
