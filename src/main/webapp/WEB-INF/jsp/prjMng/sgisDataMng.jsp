...
<head>
	...
	<script src="${pageContext.request.contextPath}/js/admin/sgisDataMng.js"></script>
...
<div class="tabs round mix">
	<ul>
		<li<c:if test="${db_type eq 'pg'}"> class="is-active"</c:if>><a href="sgisDataMng?db_type=pg">포스트그레스</a></li>
		<li<c:if test="${db_type eq 'hive'}"> class="is-active"</c:if>><a href="sgisDataMng?db_type=hive">하이브</a></li>
	</ul>
</div>
 -->
		...
		<div class="cols">
			<div class="col col-sm3">
				<div class="in-box line">
					<div class="tbs1">
						<div class="srch-group" style="margin-top:7px;">
							<span class="select"> 
								<select name="schema" id="schema">
									<option value="kostat">센서스_가공</option>
									<option value="kostat_collect">센서스_수집</option>
									<option value="kostat_analysis">센서스_분석</option>
								</select>
							</span>
						</div>
						<table id="table_list">
				...
				<div class="in-box line">
					...
					<div class="btn-right">
						<div class="btn-group line ">
							...
							<!-- <button type="button" id="tableTransfer">전송</button> -->
						</div>
					</div>					
				</div>
