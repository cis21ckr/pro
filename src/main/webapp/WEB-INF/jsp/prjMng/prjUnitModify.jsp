...
<head>
	...
	<script src="${pageContext.request.contextPath}/js/admin/prjUnitModify.js"></script>
	...
	<script>
      		$(document).ready(
	   			function() {
	   			 	var prj_master_hst_seq = "${prj_master_hst_seq}";
	   			 	var job_order = "${job_order}";
	   			 	if (!$commonFunc.isEmpty(prj_master_hst_seq) && !$commonFunc.isEmpty(job_order)) {
		   			 	$prjUnitModify.request.doReqWorkSetDetailInfo(prj_master_hst_seq, job_order);
	   			 	}
	   				// mng_s 2019. 06. 04 j.h.Seok
						...
						<div class="tb-tit">
							...
							<div class="tit-utils">
								<div class="btn-group line">
									<button id="btnExec" type="button">실행</button>
									<button id="btnSave" type="button">저장</button>
									<button id="btnList" type="button" onclick="location.href='prjExec'">목록</button>
								</div>
							</div>
						</div>
						<table>
							...
							<tbody>
								...
								<tr class="collectjob">
									...
									<td colspan="3">
										...
										<!-- <span class="radios"><input type="radio" name="col_cd" id="col_cd3" value="kosis"><label for="col_cd3">코시스</label></span> --> 
								...
								<tr class="geomovjob">
									...
									<td>
										<span class="inputs"><input type="text" id="tgt_schema_nm" placeholder="스키마명"></span>
									</td>									
									<td>
								...
								<tr>
									<th class="require">로그</th>
									<td colspan="3">
										<span class="textarea">
										<textarea id="job_log" name="job_log" rows="20" cols="100"></textarea>
										</span>
									</td>
								</tr>
							</tbody>
...
<input type="hidden" name="job_setup_seq" id="job_setup_seq" />
