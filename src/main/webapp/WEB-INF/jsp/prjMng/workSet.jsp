...
<head>
	...
	<script src="${pageContext.request.contextPath}/js/admin/workSet.js"></script>
...
<div class="sub-title">
	...
	<h2>업무 자동화</h2>
	<h3>데이터 별 업무를 설정하고 관리하실 수 있습니다.</h3>
</div>
<div class="srch-form">
	<div class="row">
		<div class="cols">
		...
		<div class="cols">
			<div class="col col-1">
				<div class="in-box">
					<div class="tbs1">
						<div class="tb-tit">
							업무 자동화 목록 : <em class="total"></em>
							<div class="tit-utils">
								<div class="btn-group line">
									<button type="button" onclick="location.href='workSetNew'">+ 새 업무</button>
