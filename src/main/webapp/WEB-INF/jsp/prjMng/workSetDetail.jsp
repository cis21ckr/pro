...
<head>
	...
	<script src="${pageContext.request.contextPath}/js/admin/workSetDetail.js"></script>
	...
	<script>
      		$(document).ready(
	   			function() {
	   			 	var job_setup_seq = "${job_setup_seq}";
	   			 	if (job_setup_seq != undefined && job_setup_seq != null) {
	   			 		$workSetDetail.request.doReqWorkSetDetailInfo(job_setup_seq);
	   			 	}
