...
<head>
	...
	<script src="${pageContext.request.contextPath}/js/admin/workSetNew.js"></script>
						...
						<table>
							...
							<tbody>
								...
								<tr class="geojob">
									...
									*** 다중 필드시에는 시도 시군구 읍면동 길로 주번 부번 건물명 형식으로 (예 : sido_nm sgg_nm emd_nm road_nm main_no sub_no buld_nm)
									</td>
								</tr>
								<tr class="coordconv">
