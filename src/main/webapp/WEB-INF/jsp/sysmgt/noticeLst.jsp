...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/sysMgt/noticeLst.js"></script>
...
<div class="tabs">
	<ul>
		<li class="is-active"><a href="noticeLst">공지사항</a></li>
		...
		<div class="cols">
			<div class="col col-1">
				<div class="in-box">
					<div class="tbs1">
						<div class="tb-tit">
							공지사항 목록 : <em id="cnt-page" class="total"></em>
							<div class="tit-utils">
								<div class="btn-group line">
									<button id="btnDelete" type="button">삭제</button>
									<button id="btnWrite" onclick="location.href='${pageContext.request.contextPath}/view/sysmgt/noticeForm'" type="button">글쓰기</button>
								</div>
								<span class="select"> 
						...
						<table>
							...
							<thead>
								<tr>
									<th><span class="checkbox solo"><input style="display:none"
