...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/sysMgt/useguideView.js"></script>
						...
						<div class="tb-tit">
							...
							<div class="tit-utils">
								<div class="btn-group line">
									<button id="btnList" onclick="location.href='${pageContext.request.contextPath}/view/sysmgt/useguideLst'" type="button">목록</button>
