...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/sysMgt/sampleLst.js"></script>
...
<div class="tabs">
	<ul>
		...
		<li class="is-active"><a href="sampleLst">샘플데이터</a></li>
		...
		<div class="cols">
			<div class="col col-1">
				<div class="in-box">
					<div class="tbs1">
						<div class="tb-tit">
							샘플데이터 목록 : <em id="cnt-page" class="total"></em>
							<div class="tit-utils">
								<div class="btn-group line">
									<button id="btnDelete" type="button">삭제</button>
									<button id="btnWrite" onclick="location.href='${pageContext.request.contextPath}/view/sysmgt/sampleForm'" type="button">글쓰기</button>
								</div>
								<span class="select"> 
