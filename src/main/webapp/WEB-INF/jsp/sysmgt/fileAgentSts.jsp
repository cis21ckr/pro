...
<div class="tabs">
	<ul>
		...
		<li class="is-active"><a href="">파일에이전트</a></li>
...
<div class="srch-form">
	<div class="row">
		<div class="cols">
			<div class="col col-1">
				<ul class="tabs-txt">
					<li class="is-active"><a href="">타기관 설치
							에이전트</a></li>
					<li><a href="">LDBDMS</a></li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="cols">
			<div class="col col-1">
				<div class="in-box">
					<div class="tbs1">
						<div class="tb-tit">
							파일 에이전트 목록 : <em class="total">1 / 221
								페이지 총 2210건</em>
							<div class="tit-utils">
								<span class="select"> 
						...
						<table>
							...
							<tbody>
								<tr>
									...
									<td>행자부 수집 에이전트</td>
									<td></td>
									<td><span class="label c4">ON</span></td>
								</tr>
								<tr>
									<td>1</td>
									<td>nsdi-ac</td>
									<td>국토부 수집 에이전트</td>
									<td></td>
									<td><span class="label c3">OFF</span></td>
								</tr>
							</tbody>
						</table>
					</div>
