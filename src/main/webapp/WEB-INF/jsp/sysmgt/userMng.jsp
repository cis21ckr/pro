...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/admin/userMng.js"></script>
						...
						<div class="tb-tit">
							...
							<div class="tit-utils">
								<div class="btn-group color">
									...
									<button type="button" class="c7" onclick="location.href='?grant_yn=N';">요청</button>
