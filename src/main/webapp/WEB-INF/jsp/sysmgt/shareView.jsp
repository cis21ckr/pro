...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/sysMgt/shareView.js"></script>
...
<div class="tabs">
	<ul>
		...
		<li class="is-active"><a href="shareLst">공유게시판</a></li>
	</ul>
</div>
					...
					<div class="tbs2">
						<div class="tb-tit">
							...
							<div class="tit-utils">
								<div class="btn-group line">
									<button id="btnList" onclick="location.href='${pageContext.request.contextPath}/view/sysmgt/shareLst'" type="button">목록</button>
						...
						<table>
							...
							<tbody>
								<tr>
									<th>제목</th>
									<td colspan="3">서울시 중구의 노인요양시설이
										부족한데 어디에 추가로 지을지 찾아봐야겠다</td>
								</tr>
								<tr>
									<th>작성자</th>
									<td>관리자</td>
								...
								<tr>
									<th>내용</th>
									<td colspan="3" class="tb-content">서울시 중구의
										65세 이상 1인 가구 대비 노인요양시설이
										부족해 추가로 시설을 설립해야 하는데 어느
										곳에 시설을 지어야 할까??</td>
								</tr>
								<tr>
									<th>댓글</th>
									<td colspan="3" class="tb-re"><span class="inputs"><input
											id="reply" type="text" value="" readonly></span></td>
								</tr>
							</tbody>
						</table>
					</div>
