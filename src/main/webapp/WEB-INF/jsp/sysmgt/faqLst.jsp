...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/sysMgt/faqLst.js"></script>
					...
					<div class="tb-tit">
						<div class="tit-utils">
							<div class="btn-group line">
								<button id="btnWrite" type="button" onclick="location.href='${pageContext.request.contextPath}/view/sysmgt/faqForm'">글쓰기</button>
							</div>
						</div>
					</div>
					<div class="aco-lists">
