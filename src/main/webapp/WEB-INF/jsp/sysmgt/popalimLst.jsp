...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/sysMgt/popalimLst.js"></script>
		...
		<div class="cols">
			<div class="col col-1">
				<div class="in-box">
					<div class="tbs1">
						<div class="tb-tit">
							팝업공지 목록 : <em id="cnt-page" class="total"></em>
							<div class="tit-utils">
								<div class="btn-group line">
									<button id="btnDelete" type="button">삭제</button>
									<button id="btnWrite" onclick="location.href='${pageContext.request.contextPath}/view/sysmgt/popalimForm'" type="button">글쓰기</button>
								</div>
								<span class="select"> 
