...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/useGuide/qna/qnaWriteView.js"></script>
...
<body>
	...
	<div class="subConentWrap">
		...
		<div id="qnaWriteView">
			<form class="QA" id="qnaWriteForm" method="POST" enctype="multipart/form-data">
				<table>
					<colgroup>
					...
					<tbody>
						...
						<tr>
							<th>상세내용</th>
							<td class="list">
								<textarea id="qnaWriteContentArea" tabindex="2" ></textarea>
							</td>
						</tr>
						<tr>
							<td>파일 첨부</td>
							<td>
								<div>
									<div class="list" style="padding:5px 30px;">
										<ul>
											<li>
												<span ><a id="deletFileBtn" href="javascript:void(0)" style="display:none;"><img src="/img/common/btn_minus.png" alt="파일삭제" style="margin-top:-2px;"/></a></span>
				...
				<div class="QABtn">
					<button id="qnaWriteCancelBtn" class="mr15">취소</button>	
					<button id="qnaRegBtn">등록</button>							
				</div>
			</form>
		</div>
	</div>	
